...
from services.session_store import get_session, public_session

router = APIRouter(prefix="/export", tags=["export"])


@router.get("/{session_id}/txt")
def export_as_txt(session_id: str):
...
def export_as_markdown(session_id: str):
...
def export_as_json(session_id: str):
    ...
    import json
    text = json.dumps(public_session(session), indent=2, ensure_ascii=False)

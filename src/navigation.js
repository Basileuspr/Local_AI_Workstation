...
export const appTabs = ["chats", "images", "generate", "library", "knowledge", "tools", "dashboard", "queue", "review", "image-editor", "media-manager", "workflows", "lora", "faces", "character-parts"];
export const appTabLabels = { chats: "Chat", images: "Image Gallery", generate: "Generate", library: "Prompt Index", knowledge: "Knowledge", tools: "Functions", dashboard: "Dashboard", queue: "Prompt Queue", review: "Image Review", "image-editor": "Image Editor", "media-manager": "Media Manager", workflows: "Image Workflows", lora: "LoRA", faces: "Faces", "character-parts": "Character Parts" };
